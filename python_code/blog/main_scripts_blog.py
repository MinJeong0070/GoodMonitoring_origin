...
from python_code.core_utils import (
...
input_path = f"../../전처리/블로그/4월/전처리_네이버블로그_4_0421-0430_250526.xlsx"
output_path = f"../../결과/원문기사_네이버블로그_4_0421-0430_{today}.xlsx"
...
def find_original_article_multiprocess(index, row_dict, total_count):
    ...
    try:
        title = clean_text(str(row_dict["게시글제목"]))
